    ...
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                priority = nil,
                isCd = true,
                why = "You + 4 closest allies take 20% less AoE damage for 8 sec. Easier to land value in M+ (small group) than raid. SpellID unverified — confirm in-game.",
                tags = { "defensive" },
            },
        },
    },
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                priority = nil,
                isCd = true,
                why = "Cast on an ally to stagger a percentage of their incoming damage over time instead of all at once. Flameshaper's Lifecinders additionally lets you place Obsidian Scales on an ally — combined, gives Flameshaper a real external-defensive niche. SpellID unverified — confirm in-game.",
                tags = { "defensive" },
            },
            {
                spellID = nil,
                ...
                priority = nil,
                isCd = true,
                why = "You + 4 closest allies take 20% less AoE damage for 8 sec. Harder to land full value in raid (only 4 allies covered) than M+ — use ahead of a known AoE hit, not damage in general. SpellID unverified — confirm in-game.",
                tags = { "defensive" },
            },
        },
    },
...
R[1467] = {
    solo = {
        tip = "Devastation solo (Scalecommander recommended -- best mobility and damage this season; Flameshaper only competitive on pure single-target). Weave Deep Breath into the rotation, Fire Breath and Eternity Surge on cooldown, spend Essence via Disintegrate, fill with Living Flame/Azure Strike.",
        priorities = {
            {
                spellID = 357210,
                name = "Deep Breath",
                priority = 1,
                why = "On cooldown -- real single-target damage now (not just a mobility tool), and builds Imminent Destruction stacks for Scalecommander. Cancel the flight early if there's nothing left to hit.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
                ...
                priority = 2,
                why = "Rank 1 is the efficient single-target Empower -- cast on cooldown.",
                tags = { "core" },
            },
            {
                spellID = 368847,
                ...
                priority = 3,
                why = "Rank 1 for single target -- cast on cooldown, priority inside Dragonrage.",
                tags = { "core" },
            },
            {
                spellID = 356995,
                name = "Disintegrate",
                priority = 4,
                why = "Main Essence spender -- channel fully, don't clip early.",
                tags = { "core" },
            },
            {
                spellID = 361469,
                name = "Living Flame",
                priority = 5,
                why = "Filler and Essence Burst generator -- cast on Burnout procs.",
                tags = {},
            },
            {
                spellID = 362969,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major DPS cooldown -- align with Bloodlust. All Empowers become instant inside it.",
                tags = { "major-cd" },
            },
        },
    },
    aoe = {
        tip = "Devastation AoE, 3+ targets (Scalecommander): Deep Breath once enemies are grouped, Eternity Surge ranked to match target count, switch Disintegrate to Pyre once you have 5+ targets.",
        priorities = {
            {
                spellID = 357210,
                name = "Deep Breath",
                priority = 1,
                why = "Use once enemies are grouped -- hits everything in its flight path.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
            ...
            },
            {
                ...
                priority = 4,
                why = "On cooldown -- 20% damage amp window, spend your other cooldowns inside it.",
                condition = "On cooldown",
                tags = { "core" },
            },
            {
                ...
                name = "Pyre",
                priority = 5,
                why = "Switch to this at 5+ targets -- it outdamages Disintegrate from that count up. Triggers Mass Disintegrate refunds.",
                tags = { "core" },
                when = C.AoE(5),
            },
            {
                ...
                name = "Disintegrate",
                priority = 6,
                why = "Use instead of Pyre below 5 targets.",
                tags = {},
            },
            {
                spellID = 361469,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Use on the largest pull -- spam Empowers inside it.",
                tags = { "major-cd" },
            },
        },
    },
    st = {
        tip = "Devastation raid single target (Scalecommander recommended over Flameshaper this tier): Deep Breath and both Empowers on cooldown, Shattering Star before your burst, Disintegrate as the Essence dump.",
        priorities = {
            {
                spellID = 357210,
                name = "Deep Breath",
            ...
            },
            {
                ...
                name = "Shattering Star",
                priority = 4,
                why = "On cooldown -- 20% damage amp window. Cast your strongest spells inside it.",
                condition = "On cooldown",
                tags = { "core" },
            },
            {
                ...
                name = "Disintegrate",
                priority = 5,
                why = "Main Essence spender -- do not clip the channel early.",
                tags = { "core" },
            },
            {
                spellID = 361469,
                name = "Living Flame",
                priority = 6,
                why = "Filler and Essence Burst generator.",
                tags = {},
            },
            {
                spellID = 375087,
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major DPS CD -- on cooldown. Stack with Bloodlust when available.",
                tags = { "major-cd" },
            },
        },
    },
...
R[1473] = {
    solo = {
        tip = "Augmentation solo (Chronowarden favored for raid this tier; Scalecommander still fine for 2-target cleave/M+): keep Ebon Might active at all times -- it is your most important button. Prescience yourself between casts. Fill with Upheaval and Eruption.",
        priorities = {
            {
                spellID = 395152,
                name = "Ebon Might",
                priority = 1,
                why = "Core buff -- empowers you (and allies in a group). Never let it drop.",
                isCd = true,
                tags = { "core" },
            },
            {
                ...
                name = "Prescience",
                priority = 2,
                why = "Apply to yourself for the Fate Mirror proc chance. 2 charges.",
                tags = { "core" },
            },
            {
                spellID = 396286,
                name = "Upheaval",
                priority = 3,
                why = "On cooldown -- strong personal damage, and extends Ebon Might via Sands of Time.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
                ...
                name = "Eruption",
                priority = 4,
                why = "Primary filler -- damage scales with your active empowerment stacks.",
                tags = { "core" },
            },
            {
                spellID = 361469,
            ...
            },
            {
                ...
                name = "Deep Breath",
                priority = 6,
                why = "On cooldown -- solid personal damage and mobility.",
                isCd = true,
                tags = { "cd" },
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major cooldown -- align with your own burst windows solo.",
                tags = { "major-cd" },
            },
        },
    },
    aoe = {
        tip = "Augmentation M+ (Scalecommander for 2-target cleave, Chronowarden also fine): your job is buff uptime, not personal damage. Ebon Might on all 4 allies. Prescience the two highest DPS. Eruption for Essence Burst windows. Position centrally.",
        chain = {
        ...
        priorities = {
            {
                ...
                name = "Ebon Might",
                priority = 1,
                why = "Must be 100% uptime on all 4 allies. Refresh 1-2s before expiry -- never let it drop in combat.",
                tags = { "core" },
            },
            {
                spellID = 409311,
                name = "Prescience",
                priority = 2,
                why = "Cast on the two highest DPS before every major pull. 2 charges -- always have one ready.",
                tags = { "core" },
            },
            {
                spellID = 395160,
            ...
            },
            {
                ...
                name = "Upheaval",
                priority = 4,
                why = "On cooldown -- strong group empowerment, extends Ebon Might. Cast during the buff window.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
                ...
                name = "Deep Breath",
                priority = 5,
                why = "On cooldown once enemies are grouped -- real AoE damage now.",
                isCd = true,
                tags = { "cd" },
            },
            {
    ...
    st = {
        tip = "Augmentation raid (Chronowarden favored this tier -- Mastery/Motes of Possibility build edges out Scalecommander on single target): pure support role. Your personal DPS is low -- your value is in how much damage you add to your buffed allies. Communicate Breath of Eons timing with raid leader.",
        priorities = {
            {
                spellID = 395152,
                name = "Ebon Might",
                priority = 1,
                why = "100% uptime is mandatory. Late refreshes cost your raid more damage than any personal mistake.",
                tags = { "core" },
            },
            {
                spellID = 409311,
                name = "Prescience",
                priority = 2,
                why = "Maintain on the two highest-damage allies. Track their buff durations. 2 charges.",
                tags = { "core" },
            },
            {
                spellID = 395160,
                name = "Eruption",
                priority = 3,
                why = "ST filler with Fate Mirror value -- cast immediately on Essence Burst procs.",
                tags = { "core" },
            },
            {
                spellID = 396286,
                name = "Upheaval",
                priority = 4,
                why = "On cooldown -- aligns well with Bloodlust burst windows, extends Ebon Might.",
                isCd = true,
                tags = { "cd" },
            },
            {
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Coordinate with raid leader -- use when cooldowns and Bloodlust align for maximum amplification.",
                tags = { "major-cd" },
            },
        },
    },
...
R[255] = {
    solo = {
        tip = "Survival solo (Sentinel now favored overall -- Sentinel's Mark procs cut Wildfire Bomb cooldown by 6s, pulling ahead of Dark Ranger): Misdirect to your pet before pulling. Wildfire Bomb into packs, Harpoon gap-closes. Ferocity pet provides Primal Rage (Bloodlust) and passive leech healing.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Wildfire Bomb",
                priority = 3,
                why = "Highest damage ability — use empowered by Tip of the Spear.",
                tags = { "core" },
            },
            {
                spellID = 34026,
            ...
            },
            {
                ...
                name = "Raptor Strike",
                priority = 5,
                why = "Primary generator — builds Tip of the Spear. Cast between every spender.",
                tags = { "core" },
            },
            {
                spellID = 190925,
    ...
    aoe = {
        tip = "Survival M+ (Sentinel favored -- Wildfire Bomb synergy plus Moonlight Chakram AoE): Wildfire Bomb is your primary AoE — always Tip-empowered. Raptor Strike/Swipe generates stacks on all targets. Position Takedown's Stampede to hit the whole pack.",
        chain = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Takedown",
                priority = 2,
                why = "On cooldown — triggers Stampede! (Pack Leader). Position to hit all targets.",
                tags = { "core", "cd" },
                isCd = true,
            },
            {
                ...
                name = "Wildfire Bomb",
                priority = 3,
                why = "Primary AoE — always Tip-of-the-Spear empowered for max damage.",
                tags = { "core" },
            },
            {
                spellID = 259489,
                name = "Raptor Strike",
                priority = 4,
                why = "Generator — becomes Raptor Swipe on 2+ targets. Builds Tip stacks.",
                tags = { "core" },
            },
            {
                spellID = 34026,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Large cone AoE cooldown — position to hit entire pack. Strongest on 5+ target pulls.",
                tags = { "major-cd" },
            },
            {
                spellID = 186265,
    ...
    st = {
        tip = "Survival Raid (Sentinel favored overall this tier): Focus Kill Command as primary ST spender. Raptor Strike between every spender. Takedown on cooldown — align with Bloodlust. Aspect of Eagle during ranged phases.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Wildfire Bomb",
                priority = 4,
                why = "Strong ST damage — never hold >1 charge. Always Tip-empowered.",
                tags = { "core" },
            },
            {
                spellID = 259489,
                name = "Raptor Strike",
                priority = 5,
                why = "Generator — keeps Tip of the Spear rolling. Fill every GCD.",
                tags = { "core" },
            },
            {
                spellID = 53351,
...
R[253] = {
    solo = {
        tip = "BM solo (Pack Leader favored for raid -- smoother Focus regen via Howl of the Pack Leader; Dark Ranger for M+ burst via Deathblow/Wailing Arrow): Bestial Wrath is your rotational anchor, not just another cooldown -- the vast majority of your damage happens inside its window.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Barbed Shot",
                priority = 2,
                why = "Maintain Frenzy stacks on pet. Time your last cast before Bestial Wrath comes off cooldown so you enter its window at full stacks. 2 charges.",
                tags = { "core" },
            },
            {
                spellID = 19574,
            ...
            },
            {
                ...
                name = "Kill Command",
                priority = 4,
                why = "Primary spender -- on cooldown always, especially inside Bestial Wrath.",
                tags = { "core" },
            },
            {
                spellID = 193455,
                name = "Cobra Shot",
                priority = 5,
                why = "Filler -- generates Focus, reduces Kill Command CD by 1s.",
                tags = { "active" },
            },
            {
                spellID = 271788,
    ...
    aoe = {
        tip = "BM AoE: Wild Thrash (replaced Multi-Shot) applies Beast Cleave to your pet, then maintain Barbed Shot and Kill Command as normal. Beast Cleave makes your pet hit all nearby enemies for 4 seconds.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Barbed Shot",
                priority = 3,
                why = "Maintain Frenzy -- 2 charges, use on reaching 2 charges so you don't waste one.",
                tags = { "core" },
            },
            {
                spellID = 19574,
            ...
            },
            {
                ...
                name = "Cobra Shot",
                priority = 6,
                why = "Filler -- refreshes Beast Cleave duration.",
                tags = { "active" },
            },
        },
    },
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Barbed Shot",
                priority = 2,
                why = "Frenzy maintenance -- never let stacks drop to 0. Time the last charge to land right before Bestial Wrath comes off cooldown.",
                tags = { "core" },
            },
            {
                spellID = 19574,
            ...
            },
            {
                ...
                name = "Kill Command",
                priority = 4,
                why = "Primary damage -- on cooldown always, especially inside Bestial Wrath.",
                tags = { "core" },
            },
            {
                spellID = 193455,
                name = "Cobra Shot",
                priority = 5,
                why = "Filler -- do not overcap Focus.",
                tags = { "active" },
            },
            {
                spellID = 271788,
...
R[254] = {
    solo = {
        tip = "MM solo (Dark Ranger favored for raid via Trueshot->Wailing Arrow; Sentinel viable on cleave fights): cast Trueshot on cooldown, spam Aimed Shot with Precise Shots procs. Rapid Fire as your second major ability. Arcane Shot as filler. Fully ranged — great for questing safety.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Aimed Shot",
                priority = 2,
                why = "Primary nuke — cast with Precise Shots buff for reduced cast time.",
                tags = { "core" },
            ...
            },
            {
                ...
                name = "Rapid Fire",
                priority = 3,
                why = "Channeled — highest DPS per GCD. On cooldown.",
                tags = { "core" },
            },
            {
                spellID = 185358,
                name = "Arcane Shot",
                priority = 4,
                why = "Filler — spends Precise Shots procs, generates Focus.",
                tags = { "active" },
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Primary CD — on cooldown. Aimed Shot and Rapid Fire both grant Precise Shots inside.",
                tags = { "major-cd" },
            },
            {
                spellID = 271788,
    ...
    aoe = {
        tip = "MM AoE (Sentinel favored on cleave -- Trueshot into Moonlight Chakram): Multi-Shot applies Trick Shots — Aimed Shot and Rapid Fire then ricochet to all nearby targets. Volley for large packs. Trick Shots is the AoE mechanic — maintain it.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Multi-Shot",
                priority = 2,
                why = "Apply Trick Shots — makes Aimed Shot and Rapid Fire ricochet to all targets.",
                tags = { "core" },
            },
            {
                spellID = 19434,
                name = "Aimed Shot",
                priority = 3,
                why = "Ricochets via Trick Shots — primary AoE damage inside Trick Shots window.",
                tags = { "core" },
            },
            {
                spellID = 257044,
                name = "Rapid Fire",
                priority = 4,
                why = "Channels and ricochets — strong AoE, use on cooldown.",
                tags = { "core" },
            },
            {
                spellID = 260243,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major CD — cast with Trick Shots active and on large pull.",
                tags = { "major-cd" },
            },
        },
    },
    st = {
        tip = "MM Raid (Dark Ranger favored for raid single-target): pure ranged, safest Hunter spec for mechanics. Aimed Shot with Precise Shots, Rapid Fire on cooldown. Trueshot aligned with Bloodlust. Double Tap before Trueshot for opener.",
        priorities = {
            {
                spellID = 257284,
                name = "Hunter's Mark",
            ...
            },
            {
                ...
                name = "Rapid Fire",
                priority = 3,
                why = "On cooldown — generates Precise Shots.",
                tags = { "core" },
            },
            {
                spellID = 288613,
                name = "Trueshot",
                priority = 4,
                why = "Align with Bloodlust — opener: Trueshot → Aimed Shot → Volley (if talented).",
                tags = { "cd" },
                isCd = true,
                isMajorCd = true,
            },
            {
                ...
                name = "Arcane Shot",
                priority = 5,
                why = "Filler — spends Precise Shots, do not overcap.",
                tags = { "active" },
            },
            {
                spellID = 271788,
        ...
        priorities = {
            {
                ...
                name = "Mortal Strike",
                priority = 1,
                why = "Primary nuke. Use on cooldown.",
                tags = { "core" },
            },
            {
                spellID = 7384,
                name = "Overpower",
                priority = 2,
                why = "Free proc — use immediately, never waste.",
                tags = { "core" },
            },
            {
                spellID = 163201,
            ...
            },
            {
                ...
                name = "Slam",
                priority = 4,
                why = "Rage dump filler when MS and OP are on CD.",
                tags = { "active" },
            },
            {
                spellID = 260708,
    ...
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Cleave",
                priority = 2,
                why = "AoE rage spender, replaces Slam.",
                tags = { "core" },
            },
            {
                spellID = 12294,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Massive AoE — use on 4+ packs.",
                tags = { "cd" },
            },
        },
    },
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Mortal Strike",
                priority = 2,
                why = "Highest priority inside CS window.",
                tags = { "core" },
            },
            {
                spellID = 7384,
                name = "Overpower",
                priority = 3,
                why = "Free damage — never cap 2 charges.",
                tags = { "core" },
            },
            {
                spellID = 163201,
            ...
            { spellID = 1464, name = "Slam", priority = 5, why = "Filler outside CS window.", tags = { "active" } },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Use during Colossus Smash if talented.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Rampage",
                priority = 1,
                why = "At 80+ rage — triggers Enrage.",
                tags = { "core" },
            },
            {
                spellID = 23881,
                name = "Bloodthirst",
                priority = 2,
                why = "On cooldown — Enrage proc + self-heal.",
                tags = { "core" },
            },
            {
                spellID = 85288,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major burst CD — Rampage spam during.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Whirlwind",
                priority = 1,
                why = "Always first — enables Meat Cleaver for next 2 hits.",
                tags = { "core" },
            },
            {
                spellID = 184367,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Big packs — pop and Rampage spam.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Rampage",
                priority = 1,
                why = "80+ rage — Enrage proc is your damage steroid.",
                tags = { "core" },
            },
            {
                spellID = 23881,
                name = "Bloodthirst",
                priority = 2,
                why = "On CD — Enrage uptime is everything.",
                tags = { "core" },
            },
            {
                spellID = 85288,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Align with Bloodlust. Rampage freely.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Shield Slam",
                priority = 1,
                why = "Hardest hit + rage gen. Use on CD.",
                tags = { "core" },
            },
            {
                spellID = 6572,
                name = "Revenge",
                priority = 2,
                why = "Free proc or 20 rage — strong AoE.",
                tags = { "core" },
            },
            {
                spellID = 6343,
                name = "Thunder Clap",
                priority = 3,
                why = "AoE threat + slow. Maintain on packs.",
                tags = { "core" },
            },
            {
                spellID = 2565,
        ...
        priorities = {
            {
                ...
                name = "Thunder Clap",
                priority = 1,
                why = "AoE threat baseline — always on CD in packs.",
                tags = { "core" },
            },
            { spellID = 6572, name = "Revenge", priority = 2, why = "Strong AoE + free procs.", tags = { "core" } },
            {
                ...
                name = "Shield Slam",
                priority = 3,
                why = "Rage gen for Shield Block uptime.",
                tags = { "core" },
            },
            {
                spellID = 2565,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Massive AoE CD — use on big pulls.",
                tags = { "cd" },
            },
        },
    },
    st = {
        ...
        priorities = {
            { spellID = 23922, name = "Shield Slam", priority = 1, why = "Hardest hit + rage.", tags = { "core" } },
            {
                ...
                name = "Revenge",
                priority = 2,
                why = "Only on free proc (save rage for IP).",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                priority = 1,
                why = "Holy Power generator — melee range.",
                tags = { "core" },
            },
            {
                spellID = 20271,
                name = "Judgment",
                priority = 2,
                why = "Ranged damage + HP gen. On CD.",
                tags = { "core" },
            },
            {
                spellID = 20473,
                name = "Holy Shock",
                priority = 3,
                why = "Instant — damage or heal based on target.",
                tags = { "core" },
            },
            {
                spellID = 85673,
                name = "Word of Glory",
                priority = 4,
                why = "At 3 HP — self-heal when below 60%.",
                tags = { "core" },
            },
            {
                spellID = 275773,
                ...
                priority = 5,
                why = "Execute or during Avenging Wrath.",
                tags = { "active" },
                when = C.ExecuteOrProc(20),
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Burst CD — damage and healing increase.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Holy Shock",
                priority = 1,
                why = "Core heal — use on most injured.",
                tags = { "core" },
            },
            {
                spellID = 85222,
        ...
        priorities = {
            {
                ...
                name = "Holy Shock",
                priority = 1,
                why = "Highest priority — heals and generates HP.",
                tags = { "core" },
            },
            {
                spellID = 85673,
                name = "Word of Glory",
                priority = 2,
                why = "At 3 HP — strong single-target heal on tank.",
                tags = { "core" },
            },
            {
                spellID = 85222,
                name = "Light of Dawn",
                priority = 3,
                why = "At 3 HP if group is stacked.",
                tags = {
                    "core",
                },
            },
        ...
        priorities = {
            {
                ...
                priority = 1,
                why = "At 3 HP — active mitigation + damage.",
                tags = { "core" },
            },
            { spellID = 20271, name = "Judgment", priority = 2, why = "Generates HP + damage.", tags = { "core" } },
            {
                ...
                priority = 3,
                why = "Bouncing shield — interrupts + big damage.",
                tags = { "core" },
            },
            {
                spellID = 275779,
            ...
            },
            {
                ...
                name = "Consecration",
                priority = 5,
                why = "Ground AoE — stand in it for DR.",
                tags = { "core" },
            },
            {
                spellID = 31850,
        ...
        priorities = {
            {
                ...
                name = "Avenger's Shield",
                priority = 1,
                why = "AoE threat snap — bounces to 3 targets.",
                tags = { "core" },
            },
            {
                spellID = 26573,
                name = "Consecration",
                priority = 2,
                why = "AoE DoT — always stand in it.",
                tags = { "core" },
            },
            {
                spellID = 53600,
                name = "Shield of the Righteous",
                priority = 3,
                why = "Mitigation — maintain uptime.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Shield of the Righteous",
                priority = 1,
                why = "Active mitigation — maintain.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                priority = 1,
                why = "At 3+ Holy Power — primary spender.",
                tags = { "core" },
            },
            {
                spellID = 184575,
            ...
            },
            {
                ...
                priority = nil,
                isCd = true,
                why = "3 HP instant + AoE stun. Use on CD.",
                tags = { "cd" },
            },
            {
                spellID = 31884,
                ...
                isCd = true,
                isMajorCd = true,
                why = "Burst window — enables HoW spam.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Divine Storm",
                priority = 1,
                why = "At 3+ HP — AoE spender replaces TV.",
                tags = { "core" },
            },
            {
                spellID = 255937,
    ...
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major burst — align with Bloodlust.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Death Strike",
                priority = 1,
                why = "Self-heal — spend RP here. Never cap.",
                tags = { "core" },
            },
            {
                spellID = 206930,
                name = "Heart Strike",
                priority = 2,
                why = "RP generator — cleaves 2+ targets.",
                tags = { "core" },
            },
            {
                spellID = 195182,
                name = "Marrowrend",
                priority = 3,
                why = "Maintain 5+ Bone Shield stacks.",
                tags = { "core" },
            },
            {
                spellID = 50842,
                name = "Blood Boil",
                priority = 4,
                why = "AoE threat + disease. 2 charges.",
                tags = { "core" },
            },
            {
                spellID = 55233,
                ...
                isCd = true,
                isMajorCd = true,
                why = "30% max HP + healing received.",
                tags = { "defensive" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Blood Boil",
                priority = 1,
                why = "AoE snap threat. Never cap charges.",
                tags = { "core" },
            },
            {
                spellID = 43265,
                ...
                priority = 2,
                why = "Ground AoE + empowers Heart Strike.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Death Strike",
                priority = 1,
                why = "Primary heal — don't overcap RP.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Obliterate",
                priority = 1,
                why = "Core hit — empowered by Killing Machine.",
                tags = { "core" },
            },
            {
                spellID = 49184,
                name = "Howling Blast",
                priority = 2,
                why = "On Rime proc (free) or to apply Frost Fever.",
                tags = { "core" },
            },
            {
                spellID = 49143,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major burst — Obliterate spam during.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Remorseless Winter",
                priority = 1,
                why = "Sustained AoE — always up in packs.",
                tags = { "core" },
            },
            {
                spellID = 49184,
            ...
            },
            {
                ...
                priority = 3,
                why = "AoE RP spender (if talented).",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Obliterate",
                priority = 1,
                why = "Primary — especially with Killing Machine.",
                tags = { "core" },
            },
            {
                spellID = 49143,
        ...
        priorities = {
            {
                ...
                name = "Scourge Strike",
                priority = 1,
                why = "Pops Festering Wounds for damage.",
                tags = { "core" },
            },
            {
                spellID = 194311,
                ...
                priority = 2,
                why = "Apply 2-3 wounds to target.",
                tags = {
                    "core",
                },
            },
            {
                ...
                name = "Death Coil",
                priority = 3,
                why = "RP dump — empowers pet via Sudden Doom.",
                tags = { "core" },
            },
            {
                spellID = 63560,
            ...
            },
            {
                ...
                name = "Outbreak",
                priority = 5,
                why = "Apply Virulent Plague (disease).",
                tags = { "active" },
            },
            {
                spellID = 275699,
                ...
                isCd = true,
                isMajorCd = true,
                why = "Pops 4 wounds + summons ghouls.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Death and Decay",
                priority = 1,
                why = "Empowers SS to cleave inside.",
                tags = { "core" },
            },
            { spellID = 85948, name = "Scourge Strike", priority = 2, why = "Cleaves inside D&D.", tags = { "core" } },
            {
                ...
                name = "Epidemic",
                priority = 3,
                why = "AoE RP dump — replaces Death Coil.",
                tags = { "core" },
            },
            {
                spellID = 194311,
    ...
    solo = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Chaos Strike",
                priority = 2,
                why = "At 40+ Fury — primary ST spender.",
                tags = { "core" },
            },
            {
                spellID = 198013,
                name = "Eye Beam",
                priority = 3,
                why = "Massive AoE — use on 2+ targets or with Demonic.",
                tags = { "core" },
            },
            {
                spellID = 188499,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major burst — Annihilation replaces Chaos Strike.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Eye Beam",
                priority = 1,
                why = "Primary AoE — triggers Demonic.",
                tags = { "core" },
            },
            ...
            { spellID = 342817, name = "Glaive Tempest", priority = 3, why = "AoE if talented.", tags = { "core" } },
            {
                ...
                name = "Chaos Strike",
                priority = 4,
                why = "Dump fury to avoid capping.",
                tags = { "active" },
            },
        ...
        priorities = {
            {
                ...
                name = "Soul Cleave",
                priority = 1,
                why = "Heal + damage. Spend Fury here.",
                tags = { "core" },
            },
            {
                spellID = 258920,
            ...
            },
            {
                ...
                name = "Fracture",
                priority = 3,
                why = "Generates 2 Soul Fragments.",
                tags = { "core" },
            },
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Emergency — massive armor + HP.",
                tags = { "defensive" },
            },
        },
    },
    aoe = {
        ...
        priorities = {
            ...
            { spellID = 204596, name = "Sigil of Flame", priority = 2, why = "Ground AoE.", tags = { "core" } },
            {
                ...
                name = "Spirit Bomb",
                priority = 3,
                why = "At 4+ Souls — AoE heal + damage.",
                tags = { "core" },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            { spellID = 8921, name = "Moonfire", priority = 2, why = "Maintain DoT on target.", tags = { "core" } },
            {
                ...
                name = "Starsurge",
                priority = 3,
                why = "At 40+ Astral Power — ST spender.",
                tags = { "core" },
            },
            {
                spellID = 190984,
            ...
            },
            {
                ...
                priority = nil,
                isCd = true,
                why = "3+ targets — replaces Starsurge.",
                tags = { "cd" },
            },
            {
                spellID = 194223,
    ...
    aoe = {
        ...
        priorities = {
            ...
            { spellID = 194153, name = "Starfire", priority = 3, why = "Lunar cleave filler.", tags = { "core" } },
            {
                ...
                name = "Moonfire",
                priority = 4,
                why = "Maintain on high-HP targets.",
                tags = { "active" },
            },
            {
                spellID = 194223,
        ...
        priorities = {
            {
                ...
                name = "Starsurge",
                priority = 1,
                why = "AP spender — buffs next Wrath/Starfire.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Rake",
                priority = 1,
                why = "Maintain bleed — massive from stealth/Prowl.",
                tags = { "core" },
            },
            {
                spellID = 5221,
                name = "Shred",
                priority = 2,
                why = "CP generator — use from behind.",
                tags = { "core" },
            },
            {
                spellID = 1079,
                name = "Rip",
                priority = 3,
                why = "At 5 CP — maintain bleed always.",
                tags = { "core" },
            },
            {
                spellID = 22568,
                name = "Ferocious Bite",
                priority = 4,
                why = "At 5 CP with Rip up — finisher.",
                tags = { "core" },
            },
            {
                spellID = 106951,
                ...
                isCd = true,
                isMajorCd = true,
                why = "Burst — energy refund on finishers.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Primal Wrath",
                priority = 1,
                why = "At 5 CP — AoE Rip application.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Rake",
                priority = 1,
                why = "Maintain. Snapshot Tiger's Fury.",
                tags = { "core" },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            { spellID = 213764, name = "Swipe", priority = 3, why = "Filler AoE.", tags = { "active" } },
            {
                ...
                name = "Ironfur",
                priority = 4,
                why = "Active mitigation — spend rage.",
                tags = { "defensive" },
            },
            {
                spellID = 22842,
        ...
        priorities = {
            {
                ...
                name = "Wild Growth",
                priority = 1,
                why = "Group AoE heal — on CD when damage.",
                tags = { "core" },
            },
            {
                spellID = 774,
                name = "Rejuvenation",
                priority = 2,
                why = "Blanket on injured players.",
                tags = { "core" },
            },
            { spellID = 18562, name = "Swiftmend", priority = 3, why = "Urgent single-target.", tags = { "core" } },
            {
                ...
                name = "Efflorescence",
                priority = 4,
                why = "Ground HoT — keep under melee.",
                tags = { "core" },
            },
            {
                spellID = 33891,
        ...
        priorities = {
            {
                ...
                name = "Rejuvenation",
                priority = 1,
                why = "Blanket raid — maintain on 5+ targets.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Arcane Barrage",
                priority = 1,
                why = "At 4 charges — dump and reset.",
                tags = { "core" },
            },
            {
                spellID = 5143,
                ...
                priority = 2,
                why = "On Clearcasting proc only — free.",
                tags = { "core" },
            },
            {
                spellID = 30451,
                name = "Arcane Blast",
                priority = 3,
                why = "Charge builder — core filler.",
                tags = { "core" },
            },
            {
                spellID = 365350,
                ...
                isCd = true,
                isMajorCd = true,
                why = "Burst CD — massive damage + mana restore.",
                tags = { "cd" },
            },
            {
                spellID = 12051,
                ...
                priority = nil,
                isCd = true,
                why = "Mana recovery — use when OOM.",
                tags = { "cd" },
            },
        },
    },
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Arcane Barrage",
                priority = 2,
                why = "At 4 charges — AoE cleave dump.",
                tags = { "core" },
            },
            {
                spellID = 5143,
        ...
        priorities = {
            {
                ...
                name = "Arcane Missiles",
                priority = 1,
                why = "Clearcasting — highest priority.",
                tags = { "core" },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Fire Blast",
                priority = 2,
                why = "Always crits — use to force Hot Streak.",
                tags = { "core" },
            },
            {
                spellID = 133,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Guaranteed crits — Pyro spam.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Flamestrike",
                priority = 1,
                why = "On Hot Streak — AoE version of Pyro.",
                tags = { "core" },
            },
            {
                spellID = 257541,
            ...
            { spellID = 133, name = "Fireball", priority = 4, why = "Filler between procs.", tags = { "active" } },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Guaranteed crits = chain Flamestrikes.",
                tags = { "cd" },
            },
        },
    },
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Fire Blast",
                priority = 2,
                why = "Force Hot Streak. Never cap charges.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Flurry",
                priority = 1,
                why = "On Brain Freeze — shatters next Ice Lance.",
                tags = { "core" },
            },
            {
                spellID = 30455,
                name = "Ice Lance",
                priority = 2,
                why = "After Flurry (shatter) or Fingers of Frost.",
                tags = { "core" },
            },
    ...
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Comet Storm",
                priority = 4,
                why = "If talented — massive AoE burst.",
                tags = { "active" },
            },
            {
                spellID = 12472,
        ...
        priorities = {
            {
                ...
                name = "Flurry",
                priority = 1,
                why = "Brain Freeze → immediate Ice Lance.",
                tags = { "core" },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            { spellID = 589, name = "Shadow Word: Pain", priority = 2, why = "Maintain DoT.", tags = { "core" } },
            {
                ...
                name = "Penance",
                priority = 3,
                why = "Offensive on CD — damage + Atonement heal.",
                tags = { "core" },
            },
            {
                spellID = 17,
    ...
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Penance",
                priority = 2,
                why = "Highest Atonement throughput.",
                tags = { "core" },
            },
    ...
    st = {
        ...
        priorities = {
            ...
            { spellID = 17, name = "Power Word: Shield", priority = 4, why = "Tank maintenance.", tags = { "active" } },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Extend Atonements before burst.",
                tags = { "cd" },
            },
        },
    },
    ...
    aoe = {
        ...
        priorities = {
            ...
            { spellID = 204883, name = "Circle of Healing", priority = 2, why = "Smart AoE heal.", tags = { "core" } },
            {
                ...
                priority = 3,
                why = "Bouncing heal — always active.",
                tags = { "core" },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            },
            {
                ...
                priority = 4,
                why = "At 50 Insanity — primary spender.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Garrote",
                priority = 1,
                why = "Maintain bleed — empowered from stealth.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Slice and Dice",
                priority = 1,
                why = "Maintain attack speed buff at 5 CP.",
                tags = { "core" },
            },
            {
                spellID = 193315,
            ...
            },
            {
                ...
                name = "Roll the Bones",
                priority = 3,
                why = "Maintain buff — reroll 1-buffs.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Blade Flurry",
                priority = 1,
                why = "Enable cleave — all hits splash.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Shadowstrike",
                priority = 1,
                why = "During Shadow Dance — huge CP gen from stealth.",
                tags = { "core" },
            },
            {
                spellID = 196819,
            ...
            { spellID = 53, name = "Backstab", priority = 3, why = "CP gen outside Dance.", tags = { "core" } },
            {
                ...
                name = "Shadow Dance",
                priority = 4,
                why = "Enter stealth for Shadowstrike.",
                tags = { "core" },
            },
            {
                spellID = 212283,
    ...
    solo = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Blackout Kick",
                priority = 3,
                why = "Chi spender — alternate with TP.",
                tags = { "core" },
            },
            {
                spellID = 100780,
                name = "Tiger Palm",
                priority = 4,
                why = "Chi gen — alternate with BoK.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                priority = 1,
                why = "Primary AoE at Mark stacks.",
                tags = { "core" },
            },
            { spellID = 113656, name = "Fists of Fury", priority = 2, why = "AoE channel.", tags = { "core" } },
            {
                ...
                name = "Rising Sun Kick",
                priority = 3,
                why = "Still use for Mastery rotation.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Rising Sun Kick",
                priority = 1,
                why = "Damage + heals via Ancient Teachings.",
                tags = { "core" },
            },
            {
                spellID = 100784,
                name = "Blackout Kick",
                priority = 2,
                why = "Melee damage + triggers healing.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Renewing Mist",
                priority = 1,
                why = "On CD — enables Vivify cleave.",
                tags = { "core" },
            },
            {
                spellID = 116670,
                name = "Vivify",
                priority = 2,
                why = "Heals target + all ReM targets.",
                tags = { "core" },
            },
            {
                spellID = 107428,
        ...
        priorities = {
            {
                ...
                name = "Flame Shock",
                priority = 1,
                why = "Maintain DoT — enables Lava Burst crits.",
                tags = { "core" },
            },
            {
                spellID = 51505,
                name = "Lava Burst",
                priority = 2,
                why = "Always crits with FS up. On CD.",
                tags = { "core" },
            },
            {
                spellID = 8042,
                name = "Earth Shock",
                priority = 3,
                why = "At 60+ Maelstrom — primary spender.",
                tags = { "core" },
            },
            {
                spellID = 188196,
        ...
        priorities = {
            {
                ...
                name = "Flame Shock",
                priority = 1,
                why = "On 2-3 targets for LvB resets.",
                tags = { "core" },
            },
            {
                spellID = 61882,
                name = "Earthquake",
                priority = 2,
                why = "At 60 Maelstrom — AoE ground.",
                tags = { "core" },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Lava Lash",
                priority = 2,
                why = "Secondary melee — spreads Flame Shock.",
                tags = { "core" },
            },
            { spellID = 188389, name = "Flame Shock", priority = 3, why = "Maintain DoT.", tags = { "core" } },
            {
                ...
                name = "Lightning Bolt",
                priority = 4,
                why = "At 5+ Maelstrom Weapon stacks — instant.",
                tags = { "core" },
            },
            {
                spellID = 51533,
                ...
                isCd = true,
                isMajorCd = true,
                why = "Wolf summons — massive burst.",
                tags = { "cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                name = "Flame Shock",
                priority = 1,
                why = "Maintain DoT for LvB crits.",
                tags = {
                    "core",
                },
            },
    ...
    solo = {
        ...
        priorities = {
            ...
            { spellID = 172, name = "Corruption", priority = 2, why = "Maintain DoT.", tags = { "core" } },
            {
                ...
                priority = 3,
                why = "Maintain — enables Malefic Rapture.",
                tags = { "core" },
            },
            {
                spellID = 324536,
                ...
                priority = 4,
                why = "Primary spender — bursts all DoTs.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                priority = 1,
                why = "At 3+ Soul Shards — summons imps.",
                tags = { "core" },
            },
            {
                spellID = 104316,
            ...
            },
            {
                ...
                name = "Demonbolt",
                priority = 3,
                why = "On Demonic Core proc — instant.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Immolate",
                priority = 1,
                why = "Maintain DoT — shard gen over time.",
                tags = { "core" },
            },
            {
                spellID = 116858,
            ...
            },
            {
                ...
                name = "Conflagrate",
                priority = 3,
                why = "Instant shard gen. 2 charges.",
                tags = { "core" },
            },
    ...
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Conflagrate",
                priority = 3,
                why = "Shard gen. Don't cap charges.",
                tags = { "core" },
            },
            { spellID = 29722, name = "Incinerate", priority = 4, why = "Filler.", tags = { "active" } },
            {
