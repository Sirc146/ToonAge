...
R[1467] = {
    solo = {
        ...
        priorities = {
            {
                spellID = 357208,
                name = "Fire Breath (Empower 2-3)",
                priority = 1,
                why = "Strongest DPS cooldown — empower to rank 2+ for DoT spread.",
                tags = { "core" },
            },
            {
                spellID = 356995,
                name = "Disintegrate",
                priority = 2,
                why = "Main DPS channel — high damage if fully channeled. Don't clip.",
                tags = { "core" },
            },
            {
                spellID = 361469,
                name = "Living Flame",
                priority = 3,
                why = "Filler and proc generator. Cast during Dragonrage.",
                tags = {},
            },
            {
                spellID = 355939,
                name = "Azure Strike",
                priority = 4,
                why = "2-target cleave filler. Hits 2 enemies baseline.",
                tags = {},
            },
            {
                spellID = 368847,
                name = "Eternity Surge",
                priority = 5,
                why = "On cooldown during Dragonrage — high burst window.",
                isCd = true,
                tags = { "cd" },
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major DPS cooldown — all spells become instant during duration.",
                tags = { "major-cd" },
            },
        },
    },
        ...
        priorities = {
            {
                ...
                priority = 1,
                why = "Maximum AoE — Empower 3 spreads DoT to all targets in cone.",
                tags = { "core" },
            },
            {
                spellID = 370462,
                ...
                priority = 2,
                why = "On cooldown — debuffs target, your spells deal 20% more for 4 sec.",
                condition = "On cooldown",
                tags = { "core" },
            },
            {
                ...
                name = "Eternity Surge",
                priority = 3,
                why = "On cooldown or during Dragonrage — high burst.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
                ...
                name = "Disintegrate",
                priority = 4,
                why = "Channel on priority target — DoTs spread damage.",
                tags = {},
            },
            { spellID = 361469, name = "Living Flame", priority = 5, why = "Filler between cooldowns.", tags = {} },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Use during highest enemy count — spam Eternity Surge inside.",
                tags = { "major-cd" },
            },
        },
    },
    st = {
        ...
        priorities = {
            {
                spellID = 357208,
                name = "Fire Breath (Empower 2)",
                priority = 1,
                why = "Applies DoT — Empower 2 is more efficient than 3 for single target.",
                tags = { "core" },
            },
            {
                spellID = 370462,
                name = "Shattering Star",
                priority = 2,
                why = "On cooldown — 20% damage amp window. Cast strongest spells inside.",
                condition = "On cooldown",
                tags = { "core" },
            },
            {
                ...
                name = "Eternity Surge",
                priority = 3,
                why = "High damage on cooldown. Priority during Dragonrage.",
                isCd = true,
                tags = { "core" },
            },
            {
                ...
                name = "Disintegrate",
                priority = 4,
                why = "Main DPS channel — do not clip early.",
                tags = { "core" },
            },
        ...
        priorities = {
            {
                ...
                name = "Ebon Might",
                priority = 1,
                why = "Core buff — empowers your allies (and yourself solo). Never let it drop.",
                tags = { "core" },
            },
            {
                spellID = nil,
            ...
            },
            {
                ...
                name = "Upheaval",
                priority = 3,
                why = "On cooldown — strong personal damage and empowers nearby targets.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
                ...
                name = "Eruption",
                priority = 4,
                why = "Primary filler — deals damage scaled by your active empowerment stacks.",
                tags = { "core" },
            },
            {
                spellID = 361469,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major cooldown — align with ally burst windows. Coordinate pull timing.",
                tags = { "major-cd" },
            },
        },
    },
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Upheaval",
                priority = 4,
                why = "On cooldown — strong group empowerment. Cast during Ebon Might window.",
                isCd = true,
                tags = { "core", "cd" },
            },
            {
    ...
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Upheaval",
                priority = 4,
                why = "On cooldown — aligns well with Bloodlust burst windows.",
                isCd = true,
                tags = { "cd" },
            },
            {
    ...
    solo = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Barbed Shot",
                priority = 2,
                why = "Maintain Frenzy stacks on pet — never let stacks drop. 2 charges.",
                tags = { "core" },
            },
            {
                spellID = 34026,
                name = "Kill Command",
                priority = 3,
                why = "Primary damage ability — on cooldown always.",
                tags = { "core" },
            },
            {
                spellID = 193455,
            ...
            },
            {
                ...
                name = "Bestial Wrath",
                priority = 5,
                why = "Primary cooldown — +25% pet damage for 15s. On cooldown.",
                tags = { "cd" },
                isCd = true,
            },
            {
    ...
    aoe = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Multi-Shot",
                priority = 2,
                why = "Apply Beast Cleave — pet hits all nearby targets for 4 sec. Refresh every 3-4s.",
                tags = { "core" },
            },
            {
                spellID = 217200,
                name = "Barbed Shot",
                priority = 3,
                why = "Maintain Frenzy — 2 charges, never let drop.",
                tags = { "core" },
            },
            {
                spellID = 34026,
                name = "Kill Command",
                priority = 4,
                why = "On cooldown — spreads damage via Beast Cleave.",
                tags = { "core" },
            },
            {
                spellID = 193455,
            ...
            },
            {
                ...
                isCd = true,
                isMajorCd = true,
                why = "Major CD — use on large packs with Beast Cleave active.",
                tags = { "major-cd" },
            },
        },
    },
    st = {
        ...
        priorities = {
            ...
            },
            {
                ...
                name = "Barbed Shot",
                priority = 2,
                why = "Frenzy maintenance — never let stacks drop to 0. Highest priority at 1 stack.",
                tags = { "core" },
            },
            {
                spellID = 34026,
                name = "Kill Command",
                priority = 3,
                why = "Primary damage — on cooldown always.",
                tags = { "core" },
            },
            {
                spellID = 19574,
                name = "Bestial Wrath",
                priority = 4,
                why = "On cooldown — align with Bloodlust. Stack with trinket on-use.",
                tags = { "cd" },
                isCd = true,
            },
            {
