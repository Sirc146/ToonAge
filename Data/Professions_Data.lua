...
P[165] = {
    ...
    gearSlots = {
        tool = { name="Leatherworking Tools", recommended="Midnight Tanning Kit", bonuses="+15 Leatherworking, +10 Multicraft", source="Crafted (Leatherworking 50)", skillBonus=15 },
        accessory1 = { name="Leatherworking Accessory 1", recommended="Tanner's Apron", bonuses="+8 Resourcefulness", source="Crafted or AH", skillBonus=8 },
        accessory2 = { name="Leatherworking Accessory 2", recommended="Stitching Awl", bonuses="+8 Ingenuity", source="Crafted or AH", skillBonus=8 },
    },
    ...
    thresholds = {
        ...
        { skill=50,  rank=3, label="Midnight Dragonhide gear", benefit="Epic-track leather/mail using Dragonhide" },
        { skill=75,  rank=4, label="Armor kit upgrades",       benefit="Craftable armor kits for extra stats on any gear" },
    ...
    talentTree = {
        rows = {
            {
                { name="Leathercrafting", desc="Unlocks leather armor recipes first",      recommended=true, skillReq=1,  firstPick=true },
                { name="Mailcrafting",    desc="Unlocks mail armor recipes first",          recommended=false, skillReq=1, firstPick=false, swapAt=50 },
                { name="Kitcrafting",     desc="Unlocks armor kit (stat enhancement) recipes", recommended=false, skillReq=1, firstPick=false },
            },
            {
                { name="Tanning Mastery",    desc="+15% proc chance on all crafts",         recommended=true, skillReq=1,  firstPick=true },
                { name="Efficient Tanning",  desc="10% chance to use fewer reagents",        recommended=false, skillReq=25, firstPick=false },
                { name="Reinforced Stitching", desc="Chance to craft rank 3 armor directly", recommended=true, skillReq=50, firstPick=false },
            },
            {
                { name="Dragonhide Crafting", desc="Unlocks Midnight Dragonhide gear recipes", recommended=true, skillReq=75, firstPick=false },
                { name="Resourcefulness",  desc="50% chance to refund a reagent",           recommended=false, skillReq=50, firstPick=false },
                { name="Kit Mastery",      desc="Armor kits grant +50% more stats",         recommended=false, skillReq=75, firstPick=false },
            },
            {
                { name="Grand Leatherworker", desc="Capstone: all leather/mail rank 3+",    recommended=true, skillReq=100, firstPick=false, isCapstone=true },
                { name="Prismatic Tannery",   desc="Craft Prismatic-tier leather and mail", recommended=true, skillReq=100, firstPick=false, isCapstone=true },
            },
        },
    },
}
...
P[164] = {
    ...
    gearSlots = {
        tool = { name="Blacksmith's Hammer", recommended="Midnight Forgehammer", bonuses="+15 Blacksmithing, +10 Resourcefulness", source="Crafted (Blacksmithing 50)", skillBonus=15 },
        accessory1 = { name="Blacksmithing Accessory 1", recommended="Forge Apron", bonuses="+8 Multicraft", source="Crafted or AH", skillBonus=8 },
        accessory2 = { name="Blacksmithing Accessory 2", recommended="Tempering Tongs", bonuses="+8 Ingenuity", source="Crafted or AH", skillBonus=8 },
    },
    ...
    thresholds = {
        ...
        { skill=75,  rank=4, label="Weapon enchant sockets",   benefit="Sockets craftable into weapons for gem slots" },
    ...
    talentTree = {
        rows = {
            {
                { name="Weaponsmithing", desc="Unlocks two-hand and plate weapon recipes first",  recommended=true, skillReq=1,  firstPick=true },
                { name="Armorsmithing",  desc="Unlocks plate armor recipes first",                 recommended=false, skillReq=1, firstPick=false, swapAt=50 },
                { name="Toolsmithing",   desc="Unlocks gathering-tool recipes (Pick/Blade/Sickle)", recommended=false, skillReq=1, firstPick=false },
            },
            {
                { name="Forge Mastery",     desc="+15% proc chance on all crafts",        recommended=true, skillReq=1,  firstPick=true },
                { name="Efficient Smithing", desc="10% chance to use fewer reagents",     recommended=false, skillReq=25, firstPick=false },
                { name="Reinforced Casts",  desc="Chance to craft rank 3 armor directly", recommended=true, skillReq=50, firstPick=false },
            },
            {
                { name="Voidore Forging", desc="Unlocks Midnight Voidore gear recipes",  recommended=true, skillReq=75, firstPick=false },
                { name="Resourcefulness", desc="50% chance to refund a reagent",         recommended=false, skillReq=50, firstPick=false },
                { name="Socket Forging",  desc="Craft gem sockets into weapons",         recommended=false, skillReq=75, firstPick=false },
            },
            {
                { name="Grand Blacksmith", desc="Capstone: all plate/weapons rank 3+",     recommended=true, skillReq=100, firstPick=false, isCapstone=true },
                { name="Prismatic Forge",  desc="Craft Prismatic-tier armor and weapons", recommended=true, skillReq=100, firstPick=false, isCapstone=true },
            },
        },
    },
}
...
P[197] = {
    ...
    gearSlots = {
        tool = { name="Tailoring Tools", recommended="Midnight Sewing Kit", bonuses="+15 Tailoring, +10 Multicraft", source="Crafted (Tailoring 50)", skillBonus=15 },
        accessory1 = { name="Tailoring Accessory 1", recommended="Weaver's Thimble", bonuses="+8 Resourcefulness", source="Crafted or AH", skillBonus=8 },
        accessory2 = { name="Tailoring Accessory 2", recommended="Embroidery Needle", bonuses="+8 Ingenuity", source="Crafted or AH", skillBonus=8 },
    },
    ...
    thresholds = {
        ...
        { skill=50,  rank=3, label="Midnight Silkweave gear",  benefit="Epic-track cloth armor using rare cloth" },
        { skill=75,  rank=4, label="Bags and containers",      benefit="Craftable large bags — universal utility item" },
    ...
    talentTree = {
        rows = {
            {
                { name="Clothcrafting", desc="Unlocks cloth armor recipes first",              recommended=true, skillReq=1,  firstPick=true },
                { name="Bagcrafting",   desc="Unlocks bag/container recipes first",             recommended=false, skillReq=1, firstPick=false },
                { name="Embroidery",    desc="Unlocks cloak and cosmetic embroidery recipes",   recommended=false, skillReq=1, firstPick=false },
            },
            {
                { name="Weaving Mastery",   desc="+15% proc chance on all crafts",       recommended=true, skillReq=1,  firstPick=true },
                { name="Efficient Weaving", desc="10% chance to use fewer reagents",      recommended=false, skillReq=25, firstPick=false },
                { name="Reinforced Seams",  desc="Chance to craft rank 3 armor directly", recommended=true, skillReq=50, firstPick=false },
            },
            {
                { name="Silkweave Crafting", desc="Unlocks Midnight Silkweave gear recipes", recommended=true, skillReq=75, firstPick=false },
                { name="Resourcefulness",   desc="50% chance to refund a reagent",          recommended=false, skillReq=50, firstPick=false },
                { name="Spacious Bags",     desc="Craftable bags gain +2 extra slots",      recommended=false, skillReq=75, firstPick=false },
            },
            {
                { name="Grand Tailor",   desc="Capstone: all cloth armor rank 3+",  recommended=true, skillReq=100, firstPick=false, isCapstone=true },
                { name="Prismatic Loom", desc="Craft Prismatic-tier cloth armor",   recommended=true, skillReq=100, firstPick=false, isCapstone=true },
            },
        },
    },
}
...
P[755] = {
    ...
    gearSlots = {
        tool = { name="Jeweler's Tools", recommended="Midnight Lapidary Kit", bonuses="+15 Jewelcrafting, +10 Multicraft", source="Crafted (Jewelcrafting 50)", skillBonus=15 },
        accessory1 = { name="Jewelcrafting Accessory 1", recommended="Loupe of Precision", bonuses="+8 Resourcefulness", source="Crafted or AH", skillBonus=8 },
        accessory2 = { name="Jewelcrafting Accessory 2", recommended="Cutting Chisel", bonuses="+8 Ingenuity", source="Crafted or AH", skillBonus=8 },
    },
    ...
    thresholds = {
        ...
        { skill=75,  rank=4, label="Unique-equipped jewelry",  benefit="Jewelcrafter-only ring/necklace recipes" },
    ...
    talentTree = {
        rows = {
            {
                { name="Gemcrafting",     desc="Unlocks gem-cutting recipes first",           recommended=true, skillReq=1,  firstPick=true },
                { name="Jewelrycrafting", desc="Unlocks ring/necklace recipes first",          recommended=false, skillReq=1, firstPick=false },
                { name="Statuecrafting",  desc="Unlocks profession-tool and trinket recipes",  recommended=false, skillReq=1, firstPick=false },
            },
            {
                { name="Lapidary Mastery",  desc="+15% proc chance on all crafts",          recommended=true, skillReq=1,  firstPick=true },
                { name="Efficient Cutting", desc="10% chance to use fewer reagents",         recommended=false, skillReq=25, firstPick=false },
                { name="Precision Faceting", desc="Chance to craft rank 3 gems directly",    recommended=true, skillReq=50, firstPick=false },
            },
            {
                { name="Voidstone Cutting", desc="Unlocks Midnight Voidstone gem recipes",  recommended=true, skillReq=75, firstPick=false },
                { name="Resourcefulness",  desc="50% chance to refund a reagent",           recommended=false, skillReq=50, firstPick=false },
                { name="Unique Settings",  desc="Unlocks Jewelcrafter-only jewelry recipes", recommended=false, skillReq=75, firstPick=false },
            },
            {
                { name="Grand Jeweler",   desc="Capstone: all gems/jewelry rank 3+", recommended=true, skillReq=100, firstPick=false, isCapstone=true },
                { name="Prismatic Facet", desc="Craft Prismatic-tier gems",          recommended=true, skillReq=100, firstPick=false, isCapstone=true },
            },
        },
    },
}
...
P[773] = {
    ...
    gearSlots = {
        tool = { name="Inscription Tools", recommended="Midnight Scribing Quill", bonuses="+15 Inscription, +10 Multicraft", source="Crafted (Inscription 50)", skillBonus=15 },
        accessory1 = { name="Inscription Accessory 1", recommended="Scribe's Spectacles", bonuses="+8 Resourcefulness", source="Crafted or AH", skillBonus=8 },
        accessory2 = { name="Inscription Accessory 2", recommended="Inkwell of Focus", bonuses="+8 Ingenuity", source="Crafted or AH", skillBonus=8 },
    },
    ...
    talentTree = {
        rows = {
            {
                { name="Glyphcrafting",  desc="Unlocks combat glyph recipes first",                recommended=true, skillReq=1,  firstPick=true },
                { name="Relic Crafting", desc="Unlocks off-hand tome/relic recipes first",          recommended=false, skillReq=1, firstPick=false },
                { name="Scrollcrafting", desc="Unlocks raid consumable scroll recipes first",       recommended=false, skillReq=1, firstPick=false },
            },
            {
                { name="Scribing Mastery",  desc="+15% proc chance on all crafts",         recommended=true, skillReq=1,  firstPick=true },
                { name="Efficient Milling", desc="10% chance to use fewer reagents",        recommended=false, skillReq=25, firstPick=false },
                { name="Precise Inking",    desc="Chance to craft rank 3 glyphs directly", recommended=true, skillReq=50, firstPick=false },
            },
            {
                { name="Tome Binding",    desc="Unlocks epic-track off-hand tomes/relics", recommended=true, skillReq=75, firstPick=false },
                { name="Resourcefulness", desc="50% chance to refund a reagent",           recommended=false, skillReq=50, firstPick=false },
                { name="Bulk Scrolls",    desc="Craft raid scrolls in stacks of 3",        recommended=false, skillReq=75, firstPick=false },
            },
            {
                { name="Grand Scribe",      desc="Capstone: all glyphs/relics rank 3+", recommended=true, skillReq=100, firstPick=false, isCapstone=true },
                { name="Prismatic Inkwell", desc="Craft Prismatic-tier relics",         recommended=true, skillReq=100, firstPick=false, isCapstone=true },
            },
        },
    },
}
...
P[202] = {
    ...
    gearSlots = {
        tool = { name="Engineering Tools", recommended="Midnight Gearwrench Set", bonuses="+15 Engineering, +10 Multicraft", source="Crafted (Engineering 50)", skillBonus=15 },
        accessory1 = { name="Engineering Accessory 1", recommended="Insulated Work Gloves", bonuses="+8 Resourcefulness", source="Crafted or AH", skillBonus=8 },
        accessory2 = { name="Engineering Accessory 2", recommended="Precision Goggles", bonuses="+8 Ingenuity", source="Crafted or AH", skillBonus=8 },
    },
    ...
    thresholds = {
        ...
        { skill=50,  rank=3, label="Midnight Voidore tech",    benefit="Epic-track gadgets using Voidore components" },
        { skill=75,  rank=4, label="Armor-slot mods",          benefit="Craftable mods that socket into any gear slot" },
    ...
    talentTree = {
        rows = {
            {
                { name="Gadgetcrafting", desc="Unlocks personal utility gadgets first",          recommended=true, skillReq=1,  firstPick=true },
                { name="Munitions",      desc="Unlocks explosives/ranged gadget recipes first",  recommended=false, skillReq=1, firstPick=false },
                { name="Armor Tech",     desc="Unlocks armor-slot mod recipes first",            recommended=false, skillReq=1, firstPick=false },
            },
            {
                { name="Tinker Mastery",      desc="+15% proc chance on all crafts",         recommended=true, skillReq=1,  firstPick=true },
                { name="Efficient Tinkering", desc="10% chance to use fewer reagents",        recommended=false, skillReq=25, firstPick=false },
                { name="Precision Assembly",  desc="Chance to craft rank 3 gadgets directly", recommended=true, skillReq=50, firstPick=false },
            },
            {
                { name="Voidore Tinkering", desc="Unlocks Midnight Voidore tech recipes", recommended=true, skillReq=75, firstPick=false },
                { name="Resourcefulness",   desc="50% chance to refund a reagent",        recommended=false, skillReq=50, firstPick=false },
                { name="Modular Fitting",   desc="Armor mods gain a second bonus stat",   recommended=false, skillReq=75, firstPick=false },
            },
            {
                { name="Grand Engineer",     desc="Capstone: all gadgets/mods rank 3+",      recommended=true, skillReq=100, firstPick=false, isCapstone=true },
                { name="Prismatic Assembly", desc="Craft Prismatic-tier gadgets and mods",   recommended=true, skillReq=100, firstPick=false, isCapstone=true },
            },
        },
    },
}
