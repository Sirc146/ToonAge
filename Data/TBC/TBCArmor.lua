...
-- ══════════════════════════════════════════════════════════════════════════════
--
-- Nine classes, one armor type each, one switch at level 40. That is short
...
-- Leather to Mail, and Warriors and Paladins from Mail to Plate, at level 40 and
-- NOBODY TELLS THEM. There is no quest, no
...
TA.Data.ClassArmor = {
    -- Corrected 2026-09-16: Warriors and Paladins learn Plate Mail at level 40
    -- (trainer skill), wearing Mail before that — the same 40 breakpoint as the
    -- Hunter/Shaman Mail upgrade. "Plate from level one" was a later-expansion
    -- rule and told low-level Warriors that Mail drops were downgrades.
    WARRIOR = { final = "Plate",   from = 40, early = "Mail",
                note = "Mail until 40, then Plate from the trainer. A large survivability jump." },
    PALADIN = { final = "Plate",   from = 40, early = "Mail",
                note = "Mail until 40, then Plate from the trainer." },
