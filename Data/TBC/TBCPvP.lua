...
-- Corrected 2026-09-16 against Icy Veins' TBC Classic Subtlety PvP guide:
-- Kidney Shot is its own stun category (it does NOT share with Cheap Shot);
-- Blind shares with Cyclone, not with Scatter Shot; Sap/Gouge share with
-- Polymorph, Freezing Trap, Wyvern Sting and Repentance. Psychic Horror and
-- Turn Evil were removed — both are Wrath abilities. The reset window is
-- 15-20 seconds (the server checks every 5).
TA.Data.DRCategories = {
    { name = "Stun",         examples = "Cheap Shot, Hammer of Justice, Bash, Pounce, War Stomp, Concussion Blow, Intimidation, Shadowfury" },
    { name = "Kidney Shot",  examples = "Kidney Shot only — its own category, a clean follow-up after other stuns" },
    { name = "Fear",         examples = "Fear, Howl of Terror, Intimidating Shout, Psychic Scream, Seduction, Scare Beast" },
    { name = "Incapacitate", examples = "Polymorph, Sap, Gouge, Repentance, Freezing Trap, Wyvern Sting" },
    { name = "Disorient",    examples = "Blind, Cyclone" },
    { name = "Scatter",      examples = "Scatter Shot, Dragon's Breath" },
    { name = "Root",         examples = "Frost Nova, Entangling Roots (proc roots such as Frostbite and Improved Hamstring are tracked separately)" },
    { name = "Silence",      examples = "Silence, Spell Lock, Garrote - Silence, Arcane Torrent" },
    { name = "Horror",       examples = "Death Coil" },
}
...
TA.Data.ClassSpikes = {
    WARRIOR = "Mortal Strike (Arms) or Bloodthirst (Fury) at 31; Endless Rage (Arms) or Rampage (Fury) at 41.",
    ...
    DRUID   = "Moonkin Form at 31 Balance; Mangle at 41 Feral; Tree of Life at 41 Restoration (Lifebloom is trained at 64, not a talent).",
}
