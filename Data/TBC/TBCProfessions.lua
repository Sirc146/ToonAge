...
TA.Data.Professions = {
    ...
    ["Jewelcrafting"] = {
        tier = "top",
        summary = "Figurine trinkets and crafted jewelry; cuts every gem you socket.",
        perks = {
            "Crafted rings, necks and figurine trinkets (jewelcrafter-only gems are a Wrath addition)",
            "Figurine trinkets — solid, and available long before comparable drops",
            "Cutting your own gems saves gold on every socket as your gear improves",
        },
        pairsWith = "Mining",
    },
    ["Enchanting"] = {
        ...
        perks = {
            ...
            "Per ring: +12 spell damage, +20 healing, +4 all stats or +2 weapon damage (Striking) — there is no attack power ring enchant in TBC",
    ...
    ["Leatherworking"] = {
        ...
        perks = {
            ...
            "Crafted leather/mail sets and armor kits (Fur Lining bracer enchants are a Wrath addition)",
        },
        pairsWith = "Skinning",
    ...
    ["Tailoring"] = {
        ...
        perks = {
            "Runic and Golden Spellthread leg enchants (tradeable in TBC — tailor-only spellthreads arrive in Wrath)",
...
TA.Data.ProfessionAdvice = {
    CASTER = {
        ...
        why  = "Tailoring's bind-on-pickup Spellfire/Shadoweave sets plus two self-only ring "
            .. "enchants are the largest profession spell-power gain, and neither needs a gathering slot.",
        also = { "Jewelcrafting", "Engineering" },
    },
    MELEE = {
        best = { "Engineering", "Jewelcrafting" },
        why  = "Goggles fill the head slot for most of the expansion, and Jewelcrafting "
            .. "covers your own gem cuts plus figurine trinkets.",
    ...
    HEALER = {
        best = { "Tailoring", "Enchanting" },
        why  = "The Primal Mooncloth set (Mooncloth specialisation), with self-only ring enchants on top.",
