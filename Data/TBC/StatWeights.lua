...
-- Expertise soft cap: 7.5% (2550 rating at 90) — negates enemy dodge
-- Expertise hard cap (removes parry): 15% (5100 rating at 90, tanks only)
-- Re-verified 2026-09-06 against Icy Veins (Retribution/Protection Paladin
-- stat priority), Warcraft Tavern (Protection Warrior stat priority), and
-- foreveranoob.wordpress.com's MoP rogue hit/expertise breakdown — all
-- three independently confirm 2550 rating = 7.5% for melee hit and for the
-- expertise soft (dodge) cap, and 5100 rating = 15% for spell hit and for
-- the expertise hard (parry) cap. These numbers were already correct;
