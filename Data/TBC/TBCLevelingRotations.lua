...
TA.Data.LevelingRotations = {
    ...
    WARRIOR = {
        ...
        },
        {
            ...
            priority = {
                "Solo/questing: Devastate requires a shield, so Protection quests shield-equipped — Shield Slam, Revenge and Devastate, with Heroic Strike as a Rage dump (many Protection players level as Arms/Fury and respec at 70)",
    ...
    PRIEST = {
        ...
        },
        {
            ...
            priority = {
                ...
                "Shadow Word: Death (trained at 62) as an execute on low-HP targets",
    ...
    SHAMAN = {
        {
            ...
            priority = {
                ...
                "Stoneclaw Totem when multiple mobs are on you — it pulls their attacks onto the totem",
                "Totem of Wrath (41-point talent, level 50) and Wrath of Air Totem (trained at 64) for extra spell damage",
            },
    ...
    MAGE = {
        ...
        },
        {
            ...
            priority = {
                ...
                "Fire Blast to finish frozen/low-HP targets (Ice Lance is trained at level 66 and pairs with Shatter on frozen targets)",
                ...
                "Icy Veins (Frost talent, from about level 29) on cooldown for burst",
            },
    ...
    WARLOCK = {
        ...
        },
        {
            ...
            priority = {
                "Immolate on pull",
                "Shadow Bolt spam as the primary filler (Incinerate is trained at level 64 and becomes the filler for Fire-focused builds once Immolate is up)",
