...
--
-- Corrected 2026-09-16 (TBC mechanics, no source dispute): Arms Whirlwind
-- costs rage rather than generating it; Fire's standard 48-point build cannot
-- take Icy Veins/Cold Snap (Frost talents); Subtlety has no Blade Flurry or
-- Adrenaline Rush (Combat talents).
-- ══════════════════════════════════════════════════════════════════════════
    ...
    WARRIOR = {
        {
            ...
            priority = {
                ...
                "Whirlwind on cooldown when rage allows (it costs 25 rage — it does not generate any)",
    ...
    ROGUE = {
        ...
        },
        {
            ...
            priority = {
                ...
                "On-use trinkets/potions (Blade Flurry and Adrenaline Rush are Combat talents, not Subtlety)",
    ...
    MAGE = {
        ...
        },
        {
            ...
            priority = {
                ...
                "Combustion with trinkets/potions (Icy Veins and Cold Snap are Frost talents a standard Fire build cannot take)",
                "Scorch while moving; Fire Blast as a movement instant",
            },
