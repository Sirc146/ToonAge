...
TA.Data.SecondaryRoles = {
    ...
    PALADIN = {
        ...
        },
        {
            ...
            requiredTree = "Holy", requiredPoints = 2,   -- corrected 2026-09-16: a Holy talent, not Protection
            context = "You're tanking but the group's casters are running dry between pulls.",
            description = "A small 2-point Holy talent that boosts Blessing of Wisdom's mana return — cheap enough for a "
                .. "Protection or Retribution Paladin to pick up on the way to a Holy dip.",
            confidence = "APPROX",
            sources = {
