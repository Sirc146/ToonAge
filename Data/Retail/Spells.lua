...
S.DEV = {
    ...
    DISINTEGRATE       = 356995,
    FIRE_BREATH        = 357208,
    ETERNITY_SURGE     = 359073,  -- was 368847 (that ID is Firestorm)
    SHATTERING_STAR    = nil,     -- old ID was a phial; no active Shattering Star button in 12.1
    DRAGONRAGE         = 375087,
    DEEP_BREATH        = 357210,
}
