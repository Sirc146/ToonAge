...
P.CRAFTING_STATS = {
    ...
    -- Inspiration existed in Dragonflight only. The War Within replaced it with
    -- Concentration (a spendable resource, not a stat) + Ingenuity; Midnight keeps
    -- that model. Consumables have 2 quality ranks in Midnight, gear keeps 5.
    Ingenuity = { desc = "Chance to refund part of the Concentration spent on a craft (Ingenious Breakthrough)", icon = 4549477 },
    Concentration = { desc = "Resource (cap 1000 per profession, ~1 per 6 min) spent to guarantee a higher quality craft", icon = 4549477, isResource = true },
