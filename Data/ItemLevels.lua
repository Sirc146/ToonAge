...
Z.UPGRADE_SOURCES = {
    ...
    lfg = {
        ...
        { name = "Mythic 0", ilvl = "233-250", track = "Veteran", note = "Requires premade group — no timer" },
        {
            ...
            ilvl = "220-237",
            track = "Adventurer",
            note = "Looking for Raid — no group needed",
        },
    ...
    pvp = {
        {
            ...
            ilvl = "220-237",
            track = "Adventurer",
            note = "Honor currency — starter PvP gear",
        },
        {
            name = "Rated Arena / RBG",
            ilvl = "246-263",
            track = "Champion",
            note = "Conquest gear — requires rating",
        },
        {
            name = "Weekly PvP cache",
            ilvl = "259-276",
            track = "Hero",
            note = "Bonus at end of week for rated play",
        },
    },
}
