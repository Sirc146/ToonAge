...
local TABS = {
    ...
    { id = "builds",    label = "Talents",     module = "TalentBuilds"      },
...
local TAB_EVENTS = {
    ...
    -- Added 2026-09-07: both of these tabs read the player's LIVE talent
    -- points (builds' Secondary/Hybrid section, and Rotation's spec
    -- auto-detect) — without this they'd only refresh on a manual tab
    -- switch, not when you actually spend a point while the tab is open.
    builds    = { CHARACTER_POINTS_CHANGED=true },
