...
TR.CLASS_TELEPORTS = {
    ...
    { spellID = 193753, toZone = nil,  class = "DRUID",  label = "Dreamwalk (Emerald Dream)" },
    { spellID = 18960,  toZone = nil,  class = "DRUID",  label = "Teleport: Moonglade" },  -- destination map not yet confirmed in-game
    -- DK Death Gate
