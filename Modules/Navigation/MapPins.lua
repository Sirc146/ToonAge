-- ToonAge/Modules/Navigation/MapPins.lua
...
function MapPins.DataProvider:RefreshAllData(fromOnShow)
    ...
    for i = QT.stepIdx, #guide.steps do
        ...
        repeat -- continue wrapper
            ...
            if GP and not GP:IsStepApplicable(step) then
                break
            end
            ...
            if coordMap ~= 0 and coordMap ~= mapID then
                break
            end
