-- ToonAge/Modules/Gear/DungeonGear.lua
...
function DG:GetPlayerPrimaryStat()
    ...
    if primaryStat == LE_UNIT_STAT_INTELLECT or primaryStat == 4 then
        return "INT"
    end
    if primaryStat == LE_UNIT_STAT_AGILITY or primaryStat == 2 then
        return "AGI"
    end
    return "STR"
end
...
function DG:GetFormattedSuggestions()
    ...
    table.sort(weakSlots, function(a, b)
