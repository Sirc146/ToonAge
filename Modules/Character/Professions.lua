...
function Professions:RenderContent(parent)
    ...
    if not hasSpecs then
        ...
        AddLabel("", 6)
        AddLabel("Specialization trees, profession gear (tool + accessories), and crafting stats were introduced in |cFFFFD100Dragonflight|r. Since |cFFFFD100The War Within|r (and in |cFFFFD100Midnight|r) quality is driven by Concentration + Ingenuity instead of Inspiration; Midnight consumables have 2 quality ranks, gear 5.", 9, 0.55, 0.55, 0.55)
