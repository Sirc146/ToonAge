...
--
-- Fixed 2026-09-06: this function used to be declared ABOVE the COL_GOLD/
-- CLOSE locals below, so its fallback branch referenced them as (nil)
-- globals instead of the locals -- a real "used before declared" bug that
-- would throw "attempt to concatenate a nil value" if RAID_CLASS_COLORS
-- ever lacked an entry for a given classToken. Moved the color constants
-- above this function so the fallback branch resolves them correctly.
